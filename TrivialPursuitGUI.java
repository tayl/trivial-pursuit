...
//                    }
        ...
        private void drawQuestionPreveiw(Graphics2D g) {
            ...
            y_offset += 40;
            g.drawString("Press Space to continue...", getWidth() / 2 - image.getWidth(null) / 2, getHeight() / 2 - image.getHeight(null) / 2 + y_offset);
            }
        }
        ...
        private void drawYesNoOptions(Graphics2D g) {
            g.setColor(Color.white);
            g.setFont(new Font("Calibri", Font.BOLD, 30));
            int xOffset = graphicAssets.scaledCoordinate(100);
            int yOffset = graphicAssets.scaledCoordinate(200);
            ...
            g.drawString("(2)", xOffset + (getWidth() / 2 - image.getWidth(null) / 2 * 3) ,yOffset + (getHeight() / 2 - image.getHeight(null) / 2));
            image = graphicAssets.getImage("no_Button.png");
            g.drawImage(image, getWidth() / 2 + image.getWidth(null) / 2, getHeight() / 2 - image.getHeight(null) / 2, null);
            g.drawString("(1)", xOffset + (getWidth() / 2 + image.getWidth(null) / 2) ,yOffset + (getHeight() / 2 - image.getHeight(null) / 2));
        }
        
        private void drawQuestionResult(Graphics2D g) {
        ...
        private void drawAnswerSelectionMenu(Graphics2D g) {
            ...
            g.drawString("    1. " + answerChoices[0], getWidth() / 2 - image.getWidth(null) / 2, getHeight() / 2 - image.getHeight(null) / 2 + y_offset);
            y_offset += 40;
            g.drawString("    2. " + answerChoices[1], getWidth() / 2 - image.getWidth(null) / 2, getHeight() / 2 - image.getHeight(null) / 2 + y_offset);
            y_offset += 40;
            g.drawString("    3. " + answerChoices[2], getWidth() / 2 - image.getWidth(null) / 2, getHeight() / 2 - image.getHeight(null) / 2 + y_offset);
            y_offset += 40;
            g.drawString("    4. " + answerChoices[3], getWidth() / 2 - image.getWidth(null) / 2, getHeight() / 2 - image.getHeight(null) / 2 + y_offset);
        }
